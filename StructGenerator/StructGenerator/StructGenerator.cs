...
namespace StructGenerator.StructGenerator {
    ...
    public static class StructGenerator {
        ...
        public static void Generate(string path, string output) {
            ...
            if (di.Exists) {
                ...
                foreach (var file in di.GetFiles()) {
                    ...
                    var list = xml.Root.Elements().ToArray()[0].Elements().ToArray()[0].Elements().Reverse();
        ...
        static void Gen(string className, List<Element> data, string output = null) {
            ...
            if (output != null) {
                ...
                Console.WriteLine("No Output path entered");
            }
            Console.WriteLine(m);
        }
